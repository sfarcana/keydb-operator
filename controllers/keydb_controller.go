...
// +kubebuilder:rbac:groups=cache.github.com,resources=keydbs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cache.github.com,resources=keydbs/status,verbs=get;update;patch

func (r *KeyDBReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	_ = context.Background()
	_ = r.Log.WithValues("keydb", req.NamespacedName)
